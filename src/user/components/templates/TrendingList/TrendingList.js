          ...
          <Grid2 item xs>
            {!props.trendingPostsHome[1] ? (
              ...
              <PostCardV1
                ...
                majorName={
                  props?.trendingPostsHome[1]?.category[0]?.categoryName
                }
                majorID={props?.trendingPostsHome[1].category[0]?.categoryId}
                subjectName={
                  props?.trendingPostsHome[1]?.category[2]?.categoryName
                }
          ...
          <Grid2 item xs={5}>
            {!props.trendingPostsHome[0] ? (
              ...
              <PostCardV2
                ...
                majorName={
                  props?.trendingPostsHome[0]?.category[0]?.categoryName
                }
                majorID={props?.trendingPostsHome[0].category[0]?.categoryId}
                subjectName={
                  props?.trendingPostsHome[0]?.category[2]?.categoryName
                }
              ...
              <Grid2 item xs style={{ height: "50%" }}>
                {!props.trendingPostsHome[2] ? (
                  ...
                  <PostCardV1
                    ...
                    majorID={
                      props?.trendingPostsHome[2].category[0]?.categoryId
                    }
                    subjectName={
                      props?.trendingPostsHome[2]?.category[2]?.categoryName
                    }
                    subjectID={
                      props?.trendingPostsHome[2].category[2]?.categoryId
                    }
              ...
              <Grid2 item xs style={{ height: "50%" }}>
                {!props.trendingPostsHome[3] ? (
                  ...
                  <PostCardV1
                    ...
                    majorID={
                      props?.trendingPostsHome[3].category[0]?.categoryId
                    }
                    subjectName={
                      props?.trendingPostsHome[3]?.category[2]?.categoryName
                    }
                    subjectID={
                      props?.trendingPostsHome[3].category[2]?.categoryId
                    }
